...
import 'facility_listing_model.dart';
export 'facility_listing_model.dart';

class FacilityListingWidget extends StatefulWidget {
  const FacilityListingWidget({
    super.key,
    required this.dayCareRef,
  });

  final DocumentReference? dayCareRef;

  @override
  State<FacilityListingWidget> createState() => _FacilityListingWidgetState();
}

class _FacilityListingWidgetState extends State<FacilityListingWidget>
    with TickerProviderStateMixin {
  late FacilityListingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FacilityListingModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DaycareRecord>(
      stream: DaycareRecord.getDocument(widget.dayCareRef!),
      builder: (context, snapshot) {
        ...
        final facilityListingDaycareRecord = snapshot.data!;
                                  ...
                                  children: [
                                                              ...
                                                              children: [
                                                                RichText(
                                                                  ...
                                                                  text:
                                                                    ...
                                                                    children: [
                                                                      TextSpan(
                                                                        text: facilityListingDaycareRecord
                                                                            .address,
                                                                        style:
                                                                            const TextStyle(),
                                                                      )
                                    ...
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          facilityListingDaycareRecord.img,
                                          width: 419.0,
                                          height: 382.0,
                                          fit: BoxFit.cover,
                                        ),
