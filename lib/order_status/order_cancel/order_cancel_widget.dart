...
class OrderCancelWidget extends StatefulWidget {
  ...
  final DocumentReference? grooming;
                              ...
                              stream: queryReservationsRecord(
                                ...
                                queryBuilder: (reservationsRecord) =>
                                    reservationsRecord
                                        .where(
                                          'reservationDate',
                                          isGreaterThan: functions.tomorrow(),
                                        )
                                        .where(
                                          'status',
                                          isEqualTo: 'completed',
                                                                ...
                                                                if (functions
                                                                  ...
                                                                  await currentUserReference!
                                                                    ...
                                                                    ...mapToFirestore(
                                                                      {
                                                                        'balance':
                                                                            FieldValue.increment(listViewReservationsRecord.reservationPrice),
                                                                      },
                                                                    ),
                                                                  });
                                                                }
