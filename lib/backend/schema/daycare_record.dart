...
class DaycareRecord extends FirestoreRecord {
  DaycareRecord._(
    super.reference,
    super.data,
  ) {
  ...
  static Stream<DaycareRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => DaycareRecord.fromSnapshot(s));

  static Future<DaycareRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => DaycareRecord.fromSnapshot(s));

  static DaycareRecord fromSnapshot(DocumentSnapshot snapshot) =>
      DaycareRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static DaycareRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      DaycareRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'DaycareRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is DaycareRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createDaycareRecordData({
  String? name,
  String? img,
...
class DaycareRecordDocumentEquality implements Equality<DaycareRecord> {
  const DaycareRecordDocumentEquality();

  @override
  bool equals(DaycareRecord? e1, DaycareRecord? e2) {
  ...
  @override
  int hash(DaycareRecord? e) => const ListEquality().hash([
        e?.name,
        e?.img,
        e?.userRef,
        e?.price,
  ...
  @override
  bool isValidKey(Object? o) => o is DaycareRecord;
}
